...
const ambiguousProperties = {
  ...
  '/accounts/:accountId/ramps': [
    [
      ...
      '/to/redirect',
      '/to/redirect/url',
      '/to/redirect/expiresAt',
      '/to/interacTransfer',
      '/to/interacTransfer/autoDeposit',
      '/to/interacTransfer/recipientTransfer',
      '/to/interacTransfer/recipientTransfer/type',
      '/to/interacTransfer/recipientTransfer/value',
      '/to/interacTransfer/securityQuestion',
      '/to/interacTransfer/securityAnswer',
      '/to/interacTransfer/message',
      '/to/payId',
      '/to/payId/type',
      '/to/payId/value',
      '/to/payId/bsb',
      '/to/payId/accountNumber',
      '/from/transferMethod',
      '/from/asset',
